...
" }}}
" {{{ Italics
  let g:theme_terminal_italic = get(g:, 'theme_terminal_italic', 0)
  let s:italic = ""
  if g:theme_terminal_italic == 1
    let s:italic = "italic"
  endif
"}}}
" {{{ Bold
  let g:theme_terminal_bold = get(g:, 'theme_terminal_bold', 0)
  let s:bold = ""
  if g:theme_terminal_bold == 1
   let s:bold = "bold"
  endif
"}}}
" {{{ Colors
  let s:base00=['NONE', '235'   ] " Window background
  let s:base01=['#343d46', '237'] " Cursor line background
  let s:base02=['#4f5b66', '240'] " Highlight background
  let s:base03=['#65737e', '243'] " Comments
  let s:base04=['#a7adba', '145']
  let s:base05=['#c0c5ce', '251'] " Text
